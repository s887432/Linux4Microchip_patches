...
sam-ba -p usb -d sam9x60:0:1 -a nandflash:1:8:0xc2605007 -c write:uboot-env.bin:0x100000
sam-ba -p usb -d sam9x60:0:1 -a nandflash:1:8:0xc2605007 -c write:uboot-env.bin:0x140000
sam-ba -p usb -d sam9x60:0:1 -a nandflash:1:8:0xc2605007 -c write:sam9x60_curiosity.itb:0x180000
